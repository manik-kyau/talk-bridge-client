        ...
        <div>
            ...
            <div className="flex flex-col md:flex-row py-14">
                ...
                <section className="md:px-6 dark:text-gray-800 md:w-1/2 " data-aos="flip-down">
                    {/*  */}
                    <form onSubmit={handleSubmit(onSubmit)} className=" w-full max-w-xl p-8 mx-auto space-y-6 rounded-xl shadow-lg dark:bg-gray-50 ">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="block w-full p-2 rounded focus:outline-none focus:ring focus:ring-opacity-25 focus:dark:ring-violet-600 dark:bg-gray-100 border" />
                            {errors.image?.type === "required" && <span className="text-red-500">Please enter photo url.</span>}
                        </div>
                        <div>
