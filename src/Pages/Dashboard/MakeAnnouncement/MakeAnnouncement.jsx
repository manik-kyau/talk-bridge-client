...
const MakeAnnouncement = () => {
    ...
    const onSubmit = async(data) => {
        ...
        if(res.data.success){
            ...
            const announcementRes = await axiosSecure.post('/announcements',announcement)
        ...
        <div>
            ...
            <div>
                <div className='text-center space-y-4 mt-8'>
                    <h2 className='text-5xl font-bold'>Create Announcement</h2>
                ...
                <form
                    ...
                    <div className='mt-6'>
                        <button
                            type="submit"
                            className="bg-gradient-to-r from-[#7E90FE] to-[#9873FF] text-white text-lg w-full font-bold py-2 px-4 rounded">Add Post</button>
                    </div>
                </form>
            </div>
        </div>
